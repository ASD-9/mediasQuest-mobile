...
void main() async {
  ...
  final MediasService mediasService = MediasService(dio);
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<MediasProvider>(create: (ctx) => MediasProvider(mediasService, Provider.of<CreatorsProvider>(ctx, listen: false))),
      ],
      child: MyApp(),
    )
  );
